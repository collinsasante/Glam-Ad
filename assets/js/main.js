...
(function ($) {
	...
	$('.logo-slider').slick({
		infinite: true,
		slidesToShow: 5,  // Adjust based on how many logos you want to show at once
		slidesToScroll: 1,
		arrows: false,
		autoplay: true,
		autoplaySpeed: 2000,  // Speed of the slide
	...
	var slider = new Swiper('.tp-banner-active', {
		slidesPerView: 1,
		spaceBetween: 30,
		loop: true,
		autoplay: {
